...
{
    /// <summary>
    /// TestScript400Response model
    /// </summary>
    [Preserve]
    [JsonConverter(typeof(TestScript400ResponseJsonConverter))]
    [DataContract(Name = "TestScript400Response")]
    internal class TestScript400Response : IOneOf
    {
        ...
        /// <summary>TestScript400Response Constructor</summary>
        /// <param name="value">The value as an object for TestScript400Response</param>
        /// <param name="type">The type for TestScript400Response</param>
        public TestScript400Response(object value, Type type)
        {
            this.Value = value;
            this.Type = type;
        }
        ...
        /// <summary>
        /// Converts the JSON string into an instance of TestScript400Response
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of TestScript400Response</returns>
        public static TestScript400Response FromJson(string jsonString)
        {
            if (jsonString == null)
            {
                return null;
            ...
            else
            {
                ...
                {
                    throw new MissingFieldException("TestScript400Response", DiscriminatorKey);
                }
        ...
        private static TestScript400Response DeserializeIntoActualObject(string discriminatorValue, string jsonString)
        {
            ...
            return new TestScript400Response(actualObject, concreteType);
        }

        private static TestScript400Response DeserializeIntoActualObject(string jsonString)
        {
            ...
            return new TestScript400Response(results.First().ActualObject, results.First().ActualType);
        }
    }

    /// <summary>
    /// Custom JSON converter for TestScript400Response to allow for deserialization into OneOf type
    /// </summary>
    [Preserve]
    internal class TestScript400ResponseJsonConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return TestScript400Response.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
        ...
        {
            return objectType == typeof(TestScript400Response);
        }
    }
}
