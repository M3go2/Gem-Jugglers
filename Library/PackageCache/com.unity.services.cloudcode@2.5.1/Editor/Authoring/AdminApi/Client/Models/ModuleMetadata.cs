...
namespace Unity.Services.CloudCode.Authoring.Client.Models
{
    ...
    internal class ModuleMetadata
    {
        ...
        [Preserve]
        public ModuleMetadata(string name = default, string language = "CS", Dictionary<string, string> tags = default, string signedDownloadURL = default, DateTime? dateCreated = default, DateTime? dateModified = default)
        {
            Name = name;
            Language = language;
            Tags = tags;
        ...
        /// <summary>
        /// Returns a ModuleMetadata as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
