...
{
    /// <summary>
    /// CloudCodeListScriptsResponseResultsInner model
    /// </summary>
    [Preserve]
    [DataContract(Name = "cloud_code_list_scripts_response_results_inner")]
    internal class CloudCodeListScriptsResponseResultsInner
    {
        /// <summary>
        /// Creates an instance of CloudCodeListScriptsResponseResultsInner.
        /// </summary>
        ...
        [Preserve]
        public CloudCodeListScriptsResponseResultsInner(TypeOptions type = default, string name = default, LanguageOptions language = LanguageOptions.JS, bool published = default, DateTime? lastPublishedDate = default, int? lastPublishedVersion = default)
        {
            Type = type;
            Name = name;
            Language = language;
        ...
        /// <summary>
        /// Formats a CloudCodeListScriptsResponseResultsInner into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a CloudCodeListScriptsResponseResultsInner as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
