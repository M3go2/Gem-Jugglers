...
namespace Unity.Services.CloudCode.Authoring.Client.Models
{
    ...
    internal class CloudCodeBasicErrorResponse
    {
        ...
        [Preserve]
        public CloudCodeBasicErrorResponse(string type, string title = default, int status = default, int code = default, string detail = default, string instance = default, List<object> details = default)
        {
            Type = type;
            Title = title;
            Status = status;
        ...
        /// <summary>
        /// Formats a CloudCodeBasicErrorResponse into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a CloudCodeBasicErrorResponse as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
