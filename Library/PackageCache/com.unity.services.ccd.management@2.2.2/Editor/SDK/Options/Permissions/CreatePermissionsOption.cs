using System;
using static Unity.Services.Ccd.Management.Models.CcdPermissionCreate;
...
namespace Unity.Services.Ccd.Management
{
    ...
    public class CreatePermissionsOption
    {
        ...
        /// <summary>
        /// Create parameters for creating a permission.
        /// </summary>
        /// <param name="bucketId">Id of the bucket.</param>
        /// <param name="action">Action.</param>
        /// <param name="permission">Permission.</param>
        public CreatePermissionsOption(Guid bucketId, ActionOptions action, PermissionOptions permission)
        {
            BucketId = bucketId;
            Action = action;
